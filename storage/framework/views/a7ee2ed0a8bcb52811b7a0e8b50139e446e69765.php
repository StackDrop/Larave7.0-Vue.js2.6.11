...
<head>
  ...
  <meta property="og:image" content="<?php echo e(File::exists(public_path('images/og-image-udf.jpg')) ? asset('images/og-image-udf.jpg') : asset('images/og-image.jpg')); ?>" />
  <!--END Open Graph tags-->
...
<body class="theme-<?php echo e(config('settings.theme.mode')); ?> <?php echo e($page_class); ?>">
...
<?php /**PATH F:\freelancer\full-source-code-with-laravel-and-npm\resources\views/index.blade.php ENDPATH**/ ?>